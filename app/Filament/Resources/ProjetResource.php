...
class ProjetResource extends Resource
{
        ...
        return $form
            ->schema([
                Forms\Components\Select::make('artiste_id')
                    ->relationship('artiste', 'id')
                    ->required(),
                Forms\Components\DateTimePicker::make('start_vote')
                    ->required(),
                Forms\Components\DateTimePicker::make('end_vote')
                    ->required(),
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                Tables\Columns\TextColumn::make('artiste.id')
                    ->numeric()
                    ->sortable(),
                Tables\Columns\TextColumn::make('start_vote')
                    ->dateTime()
                    ->sortable(),
                Tables\Columns\TextColumn::make('end_vote')
                    ->dateTime()
                    ->sortable(),
